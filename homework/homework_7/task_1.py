...
# CODUL TĂU VINE MAI JOS:
def task_4(matrix):
    list_from_matrix = [item for array in matrix for item in array]
    return list_from_matrix
    pass
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
def task_5(n):
    list_strings = ["impar" if i % 2 != 0 else "par" for i in range(1, n + 1)]
    return list_strings
    pass
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
def task_6(n):
    dict_power = dict(map(lambda pair: pair, zip(range(1, n + 1), (power ** 3 for power in range(1, n + 1)))))
    return dict_power
    pass
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
def task_7(n):
    set_multiples = {i * 3 for i in range(1, n // 3 + 1)}
    return set_multiples
    pass
# CODUL TĂU VINE MAI SUS:
...
# CODUL TĂU VINE MAI JOS:
def task_10(name, age, city="No data"):
...
def task_21(n):
    ...
    while temp_n > 0:
        ...
        suma_puterilor += pow(last_digit, nr_of_digits)
        temp_n /= 10
        temp_n = math.floor(temp_n)

    return suma_puterilor == n
    pass
# CODUL TĂU VINE MAI SUS:
